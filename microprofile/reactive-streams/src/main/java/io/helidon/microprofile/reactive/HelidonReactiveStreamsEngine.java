...
public final class HelidonReactiveStreamsEngine implements ReactiveStreamsEngine {
    ...
    static void requireNullSource(Object o, Stage stage) {
        if (o != null) {
            throw new IllegalArgumentException("Graph already has a source-like stage! Found " + stage.getClass()
                    .getSimpleName());
        }
    }
    ...
    static void requireNullFront(Object o, Stage stage) {
        if (o != null) {
            throw new IllegalArgumentException("Graph already has an inlet Subscriber! Found " + stage.getClass()
                    .getSimpleName());
        }
    }
        ...
        if (stage != null) {
            ...
            for (;;) {
                ...
                if (stage instanceof Stage.Coupled) {
                    ...
                    Flow.Subscriber s = FlowAdapters.toFlowSubscriber((
                                                                              (SubscriberWithCompletionStage) build(
                                                                                      coupled.getSubscriber().getStages(),
                                                                                      Mode.SUBSCRIBER))
                                                                              .getSubscriber());
