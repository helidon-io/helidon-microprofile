...
@ConnectorAttribute(name = JmsConnector.ACK_MODE_ATTRIBUTE,
        ...
        type = "io.helidon.microprofile.messaging.connectors.jms.AcknowledgeMode")
...
public interface AqConnector extends ConnectorFactory {
    ...
    /**
     * Provides a {@link io.helidon.microprofile.messaging.connectors.jms.JmsConnector.JmsConnectorBuilder} for creating
     * a {@link io.helidon.microprofile.messaging.connectors.jms.JmsConnector} instance.
     *
    ...
    class AqConnectorBuilder implements Builder<AqConnectorBuilder, AqConnectorImpl> {
         ...
         * {@value io.helidon.microprofile.messaging.connectors.jms.JmsConnector#NAMED_FACTORY_ATTRIBUTE}.
         *
