...
class SchemaGeneratorTest extends AbstractGraphQLTest {
    ...
    public void testGettersPerson() throws IntrospectionException, ClassNotFoundException {
        Map<String, SchemaGeneratorHelper.DiscoveredMethod> mapMethods = schemaGenerator.retrieveGetterBeanMethods(Person.class,
                                                                                                                   false);
    ...
    public void testMultipleLevels() throws IntrospectionException, ClassNotFoundException {
        Map<String, SchemaGeneratorHelper.DiscoveredMethod> mapMethods = schemaGenerator.retrieveGetterBeanMethods(Level0.class,
                                                                                                                   false);
        assertThat(mapMethods, is(notNullValue()));
    ...
    public void testInterfaceImplementorDiscovery1() throws IntrospectionException, ClassNotFoundException {
        Map<String, SchemaGeneratorHelper.DiscoveredMethod> mapMethods = schemaGenerator.retrieveGetterBeanMethods(Car.class,
                                                                                                                   false);
        assertThat(mapMethods, is(notNullValue()));
    ...
    public void testObjectWithIgnorableFields() throws IntrospectionException, ClassNotFoundException {
        Map<String, SchemaGeneratorHelper.DiscoveredMethod> mapMethods = schemaGenerator.retrieveGetterBeanMethods(
    ...
    /**
     * Assert that a {@link org.eclipse.microprofile.graphql.NumberFormat} or
     * {@link jakarta.json.bind.annotation.JsonbNumberFormat}
