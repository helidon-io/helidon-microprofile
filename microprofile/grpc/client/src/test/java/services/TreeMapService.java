 ...
 */
public class TreeMapService implements GrpcService {

    /**
     * A reference to a {@link services.TreeMapService.Person} named "Bilbo".
     */
    public static Person BILBO = new Person(1, "Bilbo", 111, "Male",
                                            new String[] {"Burglaring", "Pipe smoking"});

    /**
     * A reference to a {@link services.TreeMapService.Person} named "Frodo".
     */
    public static Person FRODO = new Person(2, "Frodo", 33, "Male",
                                            new String[] {"Long hikes"});

    /**
     * A reference to a {@link services.TreeMapService.Person} named "Aragon".
     */
    public static Person ARAGON = new Person(3, "Aragon", 87, "Male",
                                             new String[] {"Pipe smoking", "Hitting on elvish women"});

    /**
     * A reference to a {@link services.TreeMapService.Person} named "Galadriel".
     */
    public static Person GALARDRIEL = new Person(4, "Galadriel", 8372, "Female",
                                                 new String[] {"Dwarves"});

    /**
     * A reference to a {@link services.TreeMapService.Person} named "Gandalf".
     */
    public static Person GANDALF = new Person(5, "Gandalf", 32767, "Male",
                                              new String[] {"Wizardry"});

    private final TreeMap<Integer, Person> lorMap = new TreeMap<>();
    ...
    public void update(Routing routing) {
        // TODO routing.marshallerSupplier(new JavaMarshaller.Supplier());
        routing.unary("get", this::get);
        routing.serverStream("greaterOrEqualTo", this::greaterOrEqualTo);
        routing.clientStream("sumOfAges", this::sumOfAges);
        routing.bidi("persons", this::persons);
    }
