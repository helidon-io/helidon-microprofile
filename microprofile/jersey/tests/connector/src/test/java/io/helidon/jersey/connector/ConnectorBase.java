...
abstract class ConnectorBase {
    ...
    private static final String CALLER_BOUNDARY = "CallerBoundary";
    ...
    static void routing(HttpRules rules) {
        rules.get("/basic/get", ConnectorBase::basicGet)
             ...
             .post("/basic/multipart", ConnectorBase::multipartPost)
    ...
    static void multipartPost(ServerRequest request, ServerResponse response) {
    ...
    public void testMultipartBoundary() throws IOException {
        requestMultipart(MediaType.MULTIPART_FORM_DATA_TYPE);
    }

    @Test
    public void testCallerSuppliedMultipartBoundary() throws IOException {
        MediaType mediaType = new MediaType("multipart", "form-data", Map.of("boundary", CALLER_BOUNDARY));
        assertThat(requestMultipart(mediaType), is(CALLER_BOUNDARY));
    }

    private String requestMultipart(MediaType mediaType) throws IOException {
