...
Use `helidon-microprofile-core` dependency (and not the `helidon-microprofile`
dependency) and add only what you use. For example:
...
[webserver-config]: https://helidon.io/docs/latest/se/webserver/webserver#configuration-options
[webserver-socket]: https://helidon.io/docs/latest/config/io.helidon.common.socket.SocketOptions
