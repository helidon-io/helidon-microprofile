...
public final class Priorities {
     ...
     * @return priority from {@link jakarta.annotation.Priority}or the default provided
     */
     ...
     * First checks if instance is {@link io.helidon.microprofile.config.core.Prioritized}. If so,
     * uses the value from it.
     * Then checks for {@link jakarta.annotation.Priority} annotation.
     ...
     * <ul>
     * <li>If element implements {@link io.helidon.microprofile.config.core.Prioritized}, uses its priority.</li>
     ...
     * {@link io.helidon.microprofile.config.core.Prioritized}, and/or optionally annotated with
