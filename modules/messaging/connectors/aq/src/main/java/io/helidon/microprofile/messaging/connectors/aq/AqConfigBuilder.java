...
package io.helidon.microprofile.messaging.connectors.aq;

import io.helidon.config.metadata.Configured;
import io.helidon.config.metadata.ConfiguredOption;
import io.helidon.microprofile.messaging.ConnectorConfigBuilder;
import io.helidon.microprofile.messaging.connectors.jms.AcknowledgeMode;
import io.helidon.microprofile.messaging.connectors.jms.JmsConnector;
import io.helidon.microprofile.messaging.connectors.jms.Type;
...
public class AqConfigBuilder extends ConnectorConfigBuilder {
     ...
     * {@link io.helidon.microprofile.messaging.connectors.aq.AqConnector.AqConnectorBuilder#dataSource(String, javax.sql.DataSource)
    ...
    /**
     * Specify if connection is {@link io.helidon.microprofile.messaging.connectors.jms.Type#QUEUE queue}
     * or {@link io.helidon.microprofile.messaging.connectors.jms.Type#TOPIC topic}.
     *
     * @param type {@link io.helidon.microprofile.messaging.connectors.jms.Type#QUEUE queue} or
     *             {@link io.helidon.microprofile.messaging.connectors.jms.Type#TOPIC topic}
     * @return this builder
     */
