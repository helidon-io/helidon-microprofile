...
import io.helidon.microprofile.messaging.NackHandler;
import io.helidon.microprofile.messaging.Stoppable;
import io.helidon.microprofile.messaging.connectors.jms.shim.JakartaJms;
import io.helidon.microprofile.messaging.connectors.jms.shim.JakartaWrapper;
...
public class JmsConnector implements IncomingConnectorFactory, OutgoingConnectorFactory, Stoppable {
    ...
    /**
     * Builder for {@link io.helidon.microprofile.messaging.connectors.jms.JmsConnector}.
     */
