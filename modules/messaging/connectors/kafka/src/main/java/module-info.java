 ...
 */
@Features.Name("Kafka Connector")
@Features.Description("Reactive messaging connector for Kafka")
@Features.Flavor({HelidonFlavor.SE, HelidonFlavor.MP})
@Features.Path({"Messaging", "Kafka"})
@SuppressWarnings({ "requires-automatic", "requires-transitive-automatic" })
module io.helidon.microprofile.messaging.connectors.kafka {
    ...
    exports io.helidon.microprofile.messaging.connectors.kafka;
