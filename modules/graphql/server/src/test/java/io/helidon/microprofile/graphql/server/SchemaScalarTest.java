...
class SchemaScalarTest {
    ...
    public void testGetScalarAsString() {
        assertThat(new SchemaScalar("Test", Date.class.getName(), ExtendedScalars.DateTime, null).getSchemaAsString(),
                   is("scalar Test"));
        assertThat(new SchemaScalar("Date", Date.class.getName(), ExtendedScalars.DateTime, null).getSchemaAsString(),
                   is("scalar Date"));
    }
}
