...
6. Test staged bits
    1. Do quick smoke test by trying an archetype that is in the staging repo (see staging repository profile at end of this
       document)
        ...
        ```
    2. Download artifact bundle from GitHub Release workflow run (io-helidon-artifacts-x.y.z) and do any additional testing on the
       bundle such as virus scans.
