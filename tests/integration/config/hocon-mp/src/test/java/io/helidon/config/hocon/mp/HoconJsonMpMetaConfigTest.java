...
class HoconJsonMpMetaConfigTest {
    ...
    static void initialize() {
        System.setProperty("io.helidon.microprofile.config.core.meta-config", "custom-mp-meta-config.yaml");
    ...
    @AfterAll
    static void destroy() {
        System.clearProperty("io.helidon.microprofile.config.core.meta-config");
