 ...
 */
class InvalidNamedMutationIT extends AbstractGraphQlIT {

    InvalidNamedMutationIT() {
        super(Set.of(InvalidNamedTypes.ClassWithInvalidMutation.class));
    }

    @Test
    void testInvalidNamedMutation() throws IOException {
