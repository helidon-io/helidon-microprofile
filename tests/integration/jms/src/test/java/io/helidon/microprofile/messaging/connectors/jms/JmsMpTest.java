...
package io.helidon.microprofile.messaging.connectors.jms;
...
@AddConfigs({
        ...
        @AddConfig(key = "mp.messaging.incoming.test-channel-custom-mapper-fromJms.connector", value =
                JmsConnector.CONNECTOR_NAME),
        @AddConfig(key = "mp.messaging.incoming.test-channel-custom-mapper-fromJms.type", value = "queue"),
        @AddConfig(key = "mp.messaging.incoming.test-channel-custom-mapper-fromJms.destination", value =
                JmsMpTest.TEST_TOPIC_CUST_MAPPER),
        ...
        @AddConfig(key = "mp.messaging.outgoing.test-channel-custom-mapper-toJms.destination", value =
                JmsMpTest.TEST_TOPIC_CUST_MAPPER),
        ...
        @AddConfig(key = "mp.messaging.incoming.test-channel-derived-msg-fromJms.destination", value =
                JmsMpTest.TEST_TOPIC_DERIVED_1),

        @AddConfig(key = "mp.messaging.outgoing.test-channel-derived-msg-process-toJms.connector", value =
                JmsConnector.CONNECTOR_NAME),
        @AddConfig(key = "mp.messaging.outgoing.test-channel-derived-msg-process-toJms.type", value = "queue"),
        @AddConfig(key = "mp.messaging.outgoing.test-channel-derived-msg-process-toJms.destination", value =
                JmsMpTest.TEST_TOPIC_DERIVED_1),

        @AddConfig(key = "mp.messaging.incoming.test-channel-derived-msg-process-fromJms.connector", value =
                JmsConnector.CONNECTOR_NAME),
        @AddConfig(key = "mp.messaging.incoming.test-channel-derived-msg-process-fromJms.type", value = "queue"),
        @AddConfig(key = "mp.messaging.incoming.test-channel-derived-msg-process-fromJms.destination", value =
                JmsMpTest.TEST_TOPIC_DERIVED_2),
        ...
        @AddConfig(key = "mp.messaging.outgoing.test-channel-derived-msg-toJms.destination", value =
                JmsMpTest.TEST_TOPIC_DERIVED_2),
})
class JmsMpTest extends AbstractMPTest {
    ...
    void derivedJmsMessage() throws InterruptedException, ExecutionException, TimeoutException {
        AbstractSampleBean.ChannelDerivedMessage bean = CDI.current().select(AbstractSampleBean.ChannelDerivedMessage.class)
                .get();
        bean.await(50000);
        bean.assertResult();
    }
