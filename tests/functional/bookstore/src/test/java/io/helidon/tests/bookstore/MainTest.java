...
class MainTest {
    ...
    private static final String MODULE_NAME = "io.helidon.microprofile.tests.apps.bookstore";
    ...
    private static Arguments toArguments(String appJarPath, List<String> javaArgs, String moduleName, int port) {
        ...
        if (moduleName != null && !moduleName.isEmpty()) {
            ...
            // --module-path target/bookstore-se.jar:target/libs -m io.helidon.tests.apps.bookstore.se/io.helidon.tests.apps
            // .bookstore.se.Main
